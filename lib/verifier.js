...
const debug = Debug('@feathersjs/authentication-http-baisc:verify');
...
class BasicVerifier {
  constructor (app, options = {}) {
    ...
    if (!this.service) {
      throw new Error(`options.service does not exist.\n\tMake sure you are passing a valid service path or service instance and it is initialized before @feathersjs/authentication-http-basic.`);
    }
